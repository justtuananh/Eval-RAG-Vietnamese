...
if __name__ == "__main__" :
    ...
    run_rag_tests(load_eval_data(configfile.data_name) , llm= Groq_Routing(), knowledge_index= knowledge , output_file= output_file_name , verbose= False, test_settings= settings_name)